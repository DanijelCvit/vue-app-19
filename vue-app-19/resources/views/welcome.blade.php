    ...
    <div id="app" class="container">
        ...
        <form method="POST" action="/projects" @submit.prevent="onSubmit" @keydown="errors.clear($event.target.name)">
            <div class="control">
                ...
                <span v-if="errors.has('name')" class="help has-text-danger" is-danger v-text="errors.get('name')"></span>
            </div>
            <div class="control">
                <label for="description" class="label">Project Description:</label>
                <input type="text" name="description" id="description" class="input" v-model="description">
                <span v-if="errors.has('description')" class="help has-text-danger" is-danger v-text="errors.get('description')"></span>
            </div>
            <div class="control">
